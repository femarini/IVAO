...
def extract_fir_sectors(file_path, output_file_path):
    """Extracts FIR sectors from an XML file and saves them to a text file."""
    try:
        ...
        print(f"FIR sectors extracted and grouped by FIR, saved to {output_file_path}")
...
if __name__ == "__main__":
    extract_fir_sectors("fir.xml", "fir.txt")

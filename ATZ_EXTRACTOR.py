...
def extract_atz_sectors(file_path, output_file_path):
    """Extracts ATZ sectors from an XML file and saves them to a text file."""
    try:
        ...
        print(f"ATZ sectors extracted and grouped by FIR, saved to {output_file_path}")

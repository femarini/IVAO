...
def extract_cta_sectors(file_path, output_file_path):
    """Extracts CTA sectors from an XML file and saves them to a text file."""
    try:
        ...
        print(f"CTA sectors extracted and grouped by FIR, saved to {output_file_path}")
